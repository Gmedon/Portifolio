...
function sobre() {
  document
    .querySelector(".sobre-enviar")
    .scrollIntoView({ behavior: "smooth" });
}

function skills() {
  document
    .querySelector(".container-skills")
    .scrollIntoView(-100, { behavior: "smooth" });
}
...
let urlcv =
  "https://drive.google.com/file/d/14_4_FIXbxw1orCsqKujPJS6-U3jzJEty/view?usp=share_link";
function dowloadcv() {
  let win = window.open(urlcv, "_blank");
  win.focus();
}

let foto = document.querySelector(".post-foto");

foto.addEventListener("mouseover", () => {
  foto.setAttribute("src", "img/texto-sobre.png");
});

foto.addEventListener("mouseout", () => {
  foto.setAttribute("src", "img/fotominha.png");
});
